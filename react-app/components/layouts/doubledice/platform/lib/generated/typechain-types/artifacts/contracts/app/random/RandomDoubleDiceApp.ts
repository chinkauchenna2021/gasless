...
export interface RandomDoubleDiceAppInterface extends utils.Interface {
  functions: {
    ...
    "createVirtualFloor(uint256,uint32,address)": FunctionFragment;
  ...
  events: {
    ...
    "VirtualFloorCreation(uint256)": EventFragment;
  };
...
export interface RandomDoubleDiceApp extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RandomDoubleDiceAppInterface;
  ...
  callStatic: {
    ...
    resolve(vfId: BigNumberish, overrides?: CallOverrides): Promise<void>;
