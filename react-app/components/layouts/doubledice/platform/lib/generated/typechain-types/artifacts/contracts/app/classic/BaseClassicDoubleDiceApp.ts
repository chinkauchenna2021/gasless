...
export interface BaseClassicDoubleDiceAppInterface extends utils.Interface {
  functions: {
...
export interface BaseClassicDoubleDiceApp extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseClassicDoubleDiceAppInterface;
